...
int three::TexTriangleMesh::generateTexTriangleMesh(cv::Mat_<cv::Vec3f> spherePoint3D,
	cv::Mat panorama) {
	// generate triagnle mesh from panorama image
	Triangulate triangulate;
//	triangulate.triangulate(panorama);
	return 0;
}
